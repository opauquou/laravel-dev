...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect']], function () {
    ...
    // Lang Route
    Route::get('/switchLang', ['as' => 'lang.switch', 'uses' => 'UserController@switchLang']);
    ...
    Route::get('mail', ['as' => 'testMail', 'uses' => 'WelcomeController@mail']);
    ...
    Route::get('/CHARTS/data', ['as' => 'dataCharts', 'uses' => 'WelcomeController@dataCharts']);
    ...
    {
        Route::post('/charts/stats', ['as' => 'chartDataStats', 'uses' => 'WelcomeController@getDataChartStats']);
    });
