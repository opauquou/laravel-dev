...
@section('others_styles')
    ...
    <!-- bootstrap slider -->
    <link rel="stylesheet" href="{{asset('assets/plugins/bootstrap-slider/slider.css')}}">
@endsection
...
@section('others_scripts')
    <!-- Ion Slider -->
    <script src="{{asset('assets/plugins/ionslider/ion.rangeSlider.min.js')}}"></script>
    <!-- Bootstrap slider -->
    <script src="{{asset('assets/plugins/bootstrap-slider/bootstrap-slider.js')}}"></script>
@endsection
