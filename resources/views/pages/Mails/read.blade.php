                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="{{route('mailBox')}}"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">12</span></a></li>
                    ...
                    <div class="box-footer">
                        <ul class="mailbox-attachments clearfix">
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                            ...
                            <li>
                                <span class="mailbox-attachment-icon has-img"><img src="{{asset('assets/img/photo1.png')}}" alt="Attachment"></span>
                                <div class="mailbox-attachment-info">
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                            ...
                            <li>
                                <span class="mailbox-attachment-icon has-img"><img src="{{asset('assets/img/photo2.png')}}" alt="Attachment"></span>
                                <div class="mailbox-attachment-info">
